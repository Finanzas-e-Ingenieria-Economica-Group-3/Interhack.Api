...
public interface IClientService {
    ApiResponse<ClientResponseDto> addClient(ClientRequestDto request, Long companyId);
    ...
    ApiResponse<List<ClientResponseDto>> getClientsByCompanyId(Long companyId);
}
